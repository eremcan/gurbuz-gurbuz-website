...
<footer>
    <div class="container">
        <div class="row">
            <div class="widget span3">
                <h4>HAKKIMIZDA</h4>
                <p>
                <p>GÜRBÜZ & GÜRBÜZ, <strong>Av. Hüseyin GÜRBÜZ</strong> tarafından 1974 yılında İstanbul’da kurulmuş
    ...
    <div class="row">
        <div class="copyright span12 pagination-right">
            <p> &copy Copyright <?php echo date("Y"); ?>, GÜRBÜZ & GÜRBÜZ, her hakkı saklıdır.</p>
        </div>
